  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: material.Scaffold(
        ...
        backgroundColor: material.Colors.blueGrey.shade50,
        body: Stack(
          children: [
            Positioned(
              top: 0,
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            Spacer(),
                            Icon(material.Icons.menu_book_rounded, size: 50, color: material.Colors.blueGrey.shade50),
                            Text(
                              " Master Data",
                              textAlign: TextAlign.center,
                              style: textStyling.styleText5(33, material.Colors.blueGrey.shade50),
                            ),
                            Spacer(),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              ...
                              textAlign: TextAlign.center,
                              style: textStyling.styleText6(13, material.Colors.blueGrey.shade50),
                            ),
                            Spacer(),
                          ],
                        ),
            ...
            Positioned(
              top: 0,
              bottom: material.kToolbarHeight / 2,
              left: 0,
              right: 0,
              child: Stack(
                children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: widget.decorationContainer1(material.Colors.white, 20.0),
                          child: Container(
                              ...
                              children: [
                                ...
                                material.TextField(
                                  ...
                                  decoration: material.InputDecoration(
                                    border: const material.UnderlineInputBorder(),
                                    labelText: 'Password',
                                    ...
                                    suffixIcon: IconButton(
                                      ...
                                      icon: Icon(!obsText ? material.Icons.visibility_off : material.Icons.visibility),
                                    ),
                                  ),
                                ),
                                const SizedBox(
                                    ...
                                    children: [
                                      GestureDetector(
                                        onTap: () async {
                                          ...
                                          alert.alertSuccess(context: context, text: "Berhasil Login");
                                ...
                                SizedBox(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        "Version $appVersion",
                                        style: textStyling.styleText6(15, material.Colors.blueGrey.shade400),
                                      ),
                                      const Spacer(),
                                      GestureDetector(
